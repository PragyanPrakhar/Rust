...
fn main() {
    ...
    println!(
        ...
        my_person.last_name,
        my_person.birth_month,
        my_person.birth_year,
        my_person.visited_europe,
    ...
    println!(
        "Vehicle Manufacturer is {:?} , model is {:?} , Year is {:?} and the color of the vehicle is {:?}",
        my_vehicle.manufacturer, my_vehicle.model, my_vehicle.year, my_vehicle.color
    );

    let my_tuple_vehicle = new_vehicletuple();
    println!(
        "Manufacturer is {0} , Model is {1} and year is {2}",
        my_tuple_vehicle.0, my_tuple_vehicle.1, my_tuple_vehicle.2
    );
}
